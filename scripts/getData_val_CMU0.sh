# Download the datasets required for the validation inference.
# Modified from https://github.com/CMU-Perceptual-Computing-Lab/panoptic-toolbox/blob/master/scripts/getData.sh
